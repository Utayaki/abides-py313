...
class PPFL_ServiceAgent(Agent):
    ...
    def __init__(
        ...
        self.elapsed_time = {
            "STORE_MODEL": pd.Timedelta(0),
            "COMBINE_MODEL": pd.Timedelta(0),
        }
    ...
    def receiveMessage(self, currentTime, msg):
        ...
        if msg.body["msg"] == "CLIENT_WEIGHTS":
            ...
            if dt_combine_complete is not None:
                self.elapsed_time["COMBINE_MODEL"] += dt_combine_complete - dt_store_complete
